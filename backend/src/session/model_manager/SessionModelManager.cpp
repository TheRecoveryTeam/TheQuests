...
std::string SessionModelManager::SessionModelManager::get(const std::string &request, const std::vector<std::string> *projection) {
...
std::string SessionModelManager::SessionModelManager::get_by_token(const std::string &request) {
